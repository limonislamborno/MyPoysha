    ...
    try {
      ...
      if (mounted) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => OtpScreen(email: _emailController.text.trim(), isReset: true),
          ),
        );
      }
    } catch (e) {
      setState(() {
        _error = "OTP পাঠাতে সমস্যা হয়েছে। ইমেইল চেক করুন।";
      });
    } finally {
      if (mounted) {
        setState(() {
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(AppTranslations.t('forgotTitle', lang), style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
                    const SizedBox(height: 8),
                    Text(AppTranslations.t('forgotSub', lang), style: const TextStyle(color: Colors.white, fontSize: 14)),
                  ],
                ),
              ),
